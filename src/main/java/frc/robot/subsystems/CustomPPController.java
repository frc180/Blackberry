...
public class CustomPPController implements PathFollowingController {
  ...
  public ChassisSpeeds calculateRobotRelativeSpeeds(
    ...
    double rotation = rotationFF + rotationFeedback;
    if (Robot.isReal()) rotation = -rotation;
    return ChassisSpeeds.fromFieldRelativeSpeeds(
        xFF + xFeedback, yFF + yFeedback, rotation, currentPose.getRotation());
  }
  ...
  public static void setRotationTargetOverride(
      Supplier<Optional<Rotation2d>> rotationTargetOverride) {
        CustomPPController.rotationTargetOverride = rotationTargetOverride;
  }
  ...
  public static void overrideXFeedback(DoubleSupplier xFeedbackOverride) {
    CustomPPController.xFeedbackOverride = xFeedbackOverride;
  }
  ...
  public static void clearXFeedbackOverride() {
    CustomPPController.xFeedbackOverride = null;
  }
  ...
  public static void overrideYFeedback(DoubleSupplier yFeedbackOverride) {
    CustomPPController.yFeedbackOverride = yFeedbackOverride;
  }
  ...
  public static void clearYFeedbackOverride() {
    CustomPPController.yFeedbackOverride = null;
  }
  ...
  public static void overrideRotationFeedback(DoubleSupplier rotationFeedbackOverride) {
    CustomPPController.rotFeedbackOverride = rotationFeedbackOverride;
  }
  ...
  public static void clearRotationFeedbackOverride() {
    CustomPPController.rotFeedbackOverride = null;
  }

...
public class DrivetrainSubsystem extends TunerSwerveDrivetrain implements Subsystem {
    ...
    public static final double MAX_SPEED_ACCEL = Robot.isReal() ? 5.5 : 7; // was 5.5 on  real robot
    ...
    public final Trigger almostStationary = belowSpeed(Inches.of(1).per(Second)); // was 1.5

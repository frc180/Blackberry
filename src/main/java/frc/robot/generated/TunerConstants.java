...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        .withKP(80).withKI(0).withKD(0.5) // was 100p
        .withKS(0.1).withKV(3.94).withKA(0)
        .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
    // When using closed-loop control, the drive motor uses the control
    // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
    private static final Slot0Configs driveGains = new Slot0Configs()
        .withKP(0.3).withKI(0).withKD(0) // 0.3 worked, MAYBE too twitchy
        .withKS(0.21307).withKV(0.12043).withKA(0.0094501);

    // The closed-loop output type to use for th steer motors;
    // This affects the PID/FF gains for the steer motors
    private static final ClosedLoopOutputType kSteerClosedLoopOutput = ClosedLoopOutputType.Voltage;
    // The closed-loop output type to use for the drive motors;
    // This affects the PIDFF gains for the drive motors
    ...
    public static final CANBus kCANBus = new CANBus("Pseudo-Tesla", "./logs/example.hoot");

    // Theoretical free speed (m/s) at 12 V applied output;
    // This needs to be tuned to your individual robot
    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(4.8); // 5.08 theoretical
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(-0.00244140625);
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(0.30712890625);
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(-0.154052734375).plus(Degrees.of(-5));
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(0.150634765625).plus(Degrees.of(7));
